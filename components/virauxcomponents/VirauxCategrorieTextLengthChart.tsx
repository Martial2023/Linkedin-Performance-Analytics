...
const VirauxCategrorieTextLengthChart = () => {
    ...
    const fetchEngagementTextLength = async () => {
        try {
            setIsLoading(true)
            const data = await getEngagementCategrorieTextLength({ type: "viraux" })
            ...
            <div className="p-5 flex justify-between items-center">
                <div>
                    <h3 className="font-semibold text-lg text-gray-900 dark:text-white">
                        Volume du post Vs Viralité
                    </h3>
                    <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
                        Impact de la longueur du contenu sur la viralité
                    </p>
                </div>
            </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-4 flex items-start gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-medium text-gray-800 dark:text-gray-100">Viraux</h4>
                                                <p className="text-indigo-700 dark:text-indigo-300 font-semibold text-lg">~195 mots</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 flex items-start gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-medium text-gray-800 dark:text-gray-100">Non viraux</h4>
                                                <p className="text-blue-700 dark:text-blue-300 font-semibold text-lg">~167 mots</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-5 border border-gray-100 dark:border-gray-700">
                                        <p className="text-justify text-gray-700 dark:text-gray-300 leading-relaxed">
                                            Les posts viraux sur LinkedIn, avec une longueur moyenne d&apos;environ 195 mots, surpassent souvent ceux qui en sont moins (environ 167 mots), soulignant une préférence pour des contenus plus substantiels.
                                            Cependant, l&apos;écart-type élevé dans les deux catégories indique que la longueur n&apos;est pas le seul facteur ; la qualité du contenu et son alignement avec les intérêts de votre réseau restent tout aussi importants pour maximiser la portée et la viralité.
                                        </p>
                                    </div>
                                </div>
                            </div>
...
export default VirauxCategrorieTextLengthChart