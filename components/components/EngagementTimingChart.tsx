...
import { LineChart, Award, Calendar, Clock, Lightbulb } from 'lucide-react'
import IsLoadingComponent from './IsLoadingComponent'

const EngagementTimingChart = () => {
    ...
    const fetchEngagementTiming = async () => {
        try {
            setIsLoading(true)
            const data = await getEngagementTiming({type: "engagement"})
            ...
            <div className="p-5 flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
                        Meilleurs jours et moments de la semaine pour augmenter le taux d&apos;engagement.
                    </p>
                </div>
            </div>
                        ...
                        <div className="p-6 space-y-6">
                            <div className="flex gap-4">
                                ...
                                <p className="text-gray-700 dark:text-gray-200">
                                    L&apos;analyse des données d&apos;engagement par jour et période révèle des tendances claires pour optimiser la publication sur LinkedIn.
                                </p>
                            </div>
                            ...
                            <div className="flex gap-4 bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg">
                                ...
                                <div>
                                    <h4 className="font-medium text-indigo-700 dark:text-indigo-300 mb-1">Pic d&apos;engagement - Mercredi</h4>
                                    <p className="text-gray-700 dark:text-gray-200">
                                        Le <span className="font-semibold">mercredi soir</span> (530.5) et l&apos;<span className="font-semibold">après-midi du mercredi</span> (381.5) enregistrent les engagements les plus élevés, indiquant une audience B2B très active en milieu de semaine.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                                ...
                                <div>
                                    <h4 className="font-medium text-blue-700 dark:text-blue-300 mb-1">Second pic - Vendredi</h4>
                                    <p className="text-gray-700 dark:text-gray-200">
                                        Le <span className="font-semibold">vendredi</span> (jour 5) montre également un fort engagement, particulièrement en <span className="font-semibold">fin de journée</span> (359.7) et en <span className="font-semibold">milieu de matinée</span> (296.5), suggérant des moments propices pour capter l&apos;attention.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 bg-gray-50 dark:bg-gray-700/30 p-4 rounded-lg">
                                ...
                                <div>
                                    <h4 className="font-medium text-gray-700 dark:text-gray-300 mb-1">Début de semaine - Engagement modéré</h4>
                                    <p className="text-gray-700 dark:text-gray-200">
                                        Les <span className="font-semibold">lundis</span> (jour 1) et <span className="font-semibold">mardis</span> (jour 2) ont un engagement plus faible, principalement concentré dans l&apos;après-midi.
                                    </p>
                                </div>
                            </div>
...
export default EngagementTimingChart