...
import { getNbrePosts } from '@/app/actions'
import VirauxCategrorieTextLengthChart from '@/components/virauxcomponents/VirauxCategrorieTextLengthChart'
import VirauxPostThemeChart from '@/components/virauxcomponents/VirauxPostThemeChart'
import TopVirauxHashtags from '@/components/virauxcomponents/TopVirauxHashtags'
import VirauxTimingChart from '@/components/virauxcomponents/VirauxTimingChart'
  ...
  return (
    <main className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Vue d&apos;ensemble des publications virales</p>
      </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-5 gap-6 my-8">
        <div className="col-span-1 md:col-span-2 min-h-[400px] rounded-2xl overflow-hidden bg-white dark:bg-gray-800 shadow-md border border-gray-100 dark:border-gray-700">
          <VirauxCategrorieTextLengthChart />
        </div>
        ...
        <div className="col-span-1 md:col-span-3 min-h-[400px] rounded-2xl overflow-hidden bg-white dark:bg-gray-800 shadow-md border border-gray-100 dark:border-gray-700">
          <div className="p-4 h-full">
            <VirauxPostThemeChart />
          </div>
        </div>
      </section>

      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
        <div className="min-h-[400px] rounded-2xl overflow-hidden bg-white dark:bg-gray-800 shadow-md border border-gray-100 dark:border-gray-700">
      ...
      <section className="rounded-2xl overflow-hidden bg-white dark:bg-gray-800 shadow-md border border-gray-100 dark:border-gray-700 min-h-[400px] my-8">
        <div className="p-4 h-full">
          <VirauxTimingChart />
        </div>
      </section>
